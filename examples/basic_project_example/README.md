...
|------------------------|-------------------------------|-------------|
| **Main Orchestration** | `problem.py`                  | Central script tying all parts together:<br>1. Defines the surrogate model’s search space<br>2. Definition of the distribution that best captures the simulators response<br>3. Loads the simulator<br>4. Loads and processes environment data<br>5. Computes brute force solution<br>6. Calculates the quantity of interest (QoI) |
